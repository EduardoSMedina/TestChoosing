...
/**
 * JFrame que sirve para agregar una nueva Preferencia al archivo Preferencias.txt .
 */
public class AgregarPreferencias extends javax.swing.JFrame {

    public AgregarPreferencias() {
        initComponents();
         setSize(600,400);
        setLocationRelativeTo(null);
        setResizable(false);
        setTitle("Agregar preferencia:");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ingrese Preferencia");
        ...
        jLabel2.setText("Escoja Area a la cúal pertenece la Preferencia");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgregarPreferencias.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AgregarPreferencias().setVisible(true);
            }
        });
    }
